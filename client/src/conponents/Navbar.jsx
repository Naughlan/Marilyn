    ...
    <Box bg={useColorModeValue('gray.100', 'gray.900')} px={4}>
        <Flex h={16} alignItems='center' justifyContent='space-between'>
            ...
            <HStack>
                <Link as={ReactLink} to ='/'>
                    <Flex alignItems='center'>
                        <Icon as={GiTechnoHeart} h={6} w={6} color="red.600" />
                        <Text fontWeight='extrabold'>Monroe Store</Text>
                    </Flex>
                </Link>
            ...
            <Flex alignItems='center'>
                ...
                <Button as ={ReactLink} to='/registration' m={2} display={{base: 'none', md: 'inline-flex'}} fontSize ='sm' fontWeight={600} _hover={{bg: 'red.600'}} bg = 'red.800' color='white' >Sign Up</Button>
            </Flex>
        </Flex>
